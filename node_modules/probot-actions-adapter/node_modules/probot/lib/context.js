...
class Context {
     ...
     */
    get event() {
        this.log.warn(`[probot] "context.event" is deprecated. Use "context.name" instead.`);
        return this.name;
    }
    /**
     ...
     */
    get github() {
        this.log.warn(`[probot] "context.github" is deprecated. Use "context.octokit" instead.`);
        return this.octokit;
    }
}
