...
async function run(appFnOrArgv, additionalOptions) {
    ...
    const { 
    // log options
    logLevel: level, logFormat, logLevelInString, sentryDsn, 
    // server options
    ...
    log_warnings_for_obsolete_environment_variables_1.logWarningsForObsoleteEnvironmentVariables(log);
    const probotOptions = {
        appId,
        privateKey,
        redisConfig,
