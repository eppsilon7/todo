...
export declare type DeprecatedLogger = LogFn & Logger;
export declare type GetRouter = (path?: string) => express.Router;
export declare type ApplicationFunctionOptions = Probot & {
    /**
